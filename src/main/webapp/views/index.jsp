...
<div class="titl"><span class="logo"></span>
    ...
    <a class="gr public" href="javascript:;">数据浏览</a> <a href="javascript:if(confirm('确实要退出吗?'))location='login.html'"
                                                         class="quit">退出</a><span
            class="usename">欢迎您：&nbsp;&nbsp;用户名!</span></div>

<iframe src="views/superadmin.html" id="mainiframe" width="100%" frameborder="no" border="0" scrolling="no"
        height="100%"></iframe>
...
<script type="text/javascript">
    ...
    var arr = [
        ...
        './views/IM_AngularJS.jsp',
        './views/customerList.html',
        './views/person_first1.html',
    ]
    for (let i = 0; i < oLi; i++) {
